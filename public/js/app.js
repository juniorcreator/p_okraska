...
window.$ = window.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // import "babel-polyfill";
...
function () {
  ...
  _createClass(App, [{
    ...
    key: "toggle_map_order",
    value: function toggle_map_order() {
      var btn = $('.js-do-order');
      var form = $('.form-order');
    ...
    key: "call_back_popup",
    value: function call_back_popup() {
      var btn = $('.js-call-back'),
    ...
    key: "popups_opener",
    value: function popups_opener(b, s, c, isbody) {
      // b = button
      // s = select
      // c = class
    ...
    key: "call_popups",
    value: function call_popups() {
      this.popups_opener('.js-order-popup', '.order-popup', 'open', 'body');
      $(document).on('mouseup', function (e) {
        var a = $('.order-popup__wrap'); // let p = $(".form-order");
    ...
    key: "scale_smth",
    value: function scale_smth(selector, clas, scaler) {
      var select = $(selector);
      var scaller = $(scaler);
...
!function (a) {
  "function" == typeof define && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") ? define(["jquery"], a) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = a : a(jquery__WEBPACK_IMPORTED_MODULE_0___default.a);
}(function (a) {
  function b(b) {
...
!function (e) {
  "function" == typeof define && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") ? define(["jquery"], e) :  true && module.exports ? module.exports = e : e(jquery__WEBPACK_IMPORTED_MODULE_0___default.a, window, document);
}(function (e) {
  !function (t) {
